---
title: "nansen-shows"
description: "An open-source starter that turns Nansen smart-money data into seven authored shows. Clone it, swap the data adapter, and you have a data show pipeline."
---
...
The builders take plain objects in the [FlowSnapshot](/schemas/flow-snapshot) shape. Replace `src/nansen.ts` with an adapter for your data (an exchange's trade feed, DefiLlama, your own warehouse) that produces the same fields, and the seven shows work unchanged.
