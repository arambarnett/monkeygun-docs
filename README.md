...
Not only crypto: the same calls cut from [a URL](use-cases/url-to-video.md), [your footage](use-cases/footage-to-video.md) or [stocks, FX and weather](use-cases/other-data.md).
