---
title: "URL to video"
description: "Point it at a page. The facts, stills and brand colors come out of the page, and the script can only say what the page says."
---

<Frame caption="Cut from a single URL about the Pokémon card artist Mitsuhiro Arita: facts, stills and palette from the page, nothing invented.">
  <video controls muted playsInline poster="https://monkeygun.com/deck/pokemon.jpg" src="https://monkeygun.com/deck/v-mitsuhiro-arita.mp4" style={{ maxWidth: 320, borderRadius: 12 }} />
</Frame>
