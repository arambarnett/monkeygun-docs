---
title: "Authored scripts"
description: "Write the scenes yourself. Exact numbers on screen, real charts, clips from your logo, Giphy loops, sound design and transitions, with no director in the loop."
---
...
<Frame caption="Line and bar chart scenes as rendered on production (vid-384).">
  <img src="https://api.monkeygun.com/api/media/videos/vid-384/vid-384-thumb.jpg?k=49738b4111bd852a6903&t=4" alt="Line chart scene" />
</Frame>
...
<Frame caption="A 250 px CoinGecko logo turned into a 5-second Kling clip (vid-388).">
  <img src="https://api.monkeygun.com/api/media/videos/vid-388/vid-388-thumb.jpg?k=21c033efce5ec152bdda&t=3" alt="Logo-seeded clip" />
</Frame>
...
Cost: 60 (script, voice, render) + 100 (5 s Kling) + 40 (music) = 200 credits. This is the shape the open-source [nansen-shows](/examples/nansen-shows) starter sends.
