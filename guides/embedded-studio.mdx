...
description: "Put the full Monkeygun studio inside your app. Your users chat, edit and render; you get the videos, tagged with your user id, billed to your account."
---
...
Everything the user makes spends your account's credits. Price your users however you want (tokenslop sells credits at a markup and debits before the call). The studio shows the price of every step before it spends, and the [plan card](/concepts/credits-and-quotes) appears for anything over 200 credits.
