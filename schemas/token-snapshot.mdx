---
title: "TokenSnapshot"
description: "One asset at one moment. The shape tokenslop sends for every token video and the exchange listing shape."
---
...
<Frame caption="Trenches Report, a tokenslop show cut from a movers list (vid-316).">
  <img src="https://api.monkeygun.com/api/media/videos/vid-316/vid-316-thumb.jpg" alt="Trenches Report" />
</Frame>
