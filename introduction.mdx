...
Not only crypto: the same calls cut from [a URL](/use-cases/url-to-video), [your footage](/use-cases/footage-to-video) or [stocks, FX and weather](/use-cases/other-data).
